...
public class CaptureHelpers extends ScreenRecorder {
    ...
    private static LoadConfigFile loadConfigFile = new LoadConfigFile();
    ...
    public static void startRecord(String methodName) throws Exception {
        ...
        File file = new File("./"+loadConfigFile.getValueProp("exportVideoPath")+"/"+methodName+"/");
    ...
    public static void captureScreenshot(WebDriver driver, String screenName) {
        try {
            ...
            FileHandler.copy(source, new File("./"+loadConfigFile.getValueProp("exportCapturePath")+"/" + screenName + "_"+dateFormat.format(new Date())+ ".png"));
